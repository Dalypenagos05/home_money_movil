  ...
  return (
    <View style={styles.container}>
      ...
      <CustomText style={styles.description}>
        Usando nuestra app tendras la oportunidad de:{"\n"}
            • Registrar cuentas y gestionar facturas.{"\n"}
            • Seguir y analizar tus gastos.{"\n"}
            • Visualizar tus finanzas fácilmente.
      </CustomText>
